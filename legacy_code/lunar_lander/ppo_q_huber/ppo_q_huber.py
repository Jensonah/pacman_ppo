        ...
        for i in tqdm(range(num_episodes)):
            ...
            for k in range(num_epochs):
                ...
                for j in range(num_actors):
                    ...
                    #critic_loss += F.huber_loss(gamma*critic_values_action_t1, critic_values_action_t - rewards_std[j], delta=1.0, reduction='mean') # trial 0
                    critic_loss += F.huber_loss(gamma*critic_values_best_t1, critic_values_action_t - rewards_std[j], delta=1.0, reduction='mean') # trial 1
                    ...
                    advantage = gamma*critic_values_action_t1 - (critic_values_action_t - rewards_std[j])
                    ...
                    ppo_loss += torch.mean(ppo_gradient).float()# mean to normalize by length
