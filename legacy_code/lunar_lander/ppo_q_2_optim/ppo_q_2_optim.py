...
def train(
    env, actor, critic, optim_actor, optim_critic, num_episodes, num_actors, num_epochs, eps, gamma
):
        ...
        for i in tqdm(range(num_episodes)):
            ...
            for k in range(num_epochs):
                ...
                for j in range(num_actors):
                    ...
                    advantage = (
                        gamma * critic_values_action_t1 - (critic_values_action_t - rewards_std[j])
                    ).detach()
...
obj_func_hist, ppo_loss, critic_loss = train(
    env,
    actor,
    critic,
    optim_actor,
