...
class Own_loss_calculator(PPO_Q_loss_calculator):
	...
	def get_critic_loss(self):
		...
		constant = 1.25
		mse = constant *          (self.gamma*self.critic_values_best_t1 - (self.critic_values_action_t - self.rewards_std))**2
		mae = constant * torch.abs(self.gamma*self.critic_values_best_t1 - (self.critic_values_action_t - self.rewards_std))
