        ...
        for i in tqdm(range(num_episodes)):
            ...
            for k in range(num_epochs):
                ...
                for j in range(num_actors):
                    ...
                    #critic_loss += torch.mean( torch.abs(gamma*critic_values_action_t1 - (critic_values_action_t - rewards_std[j])) )
                    critic_loss += torch.mean( torch.abs(gamma*critic_values_best_t1 - (critic_values_action_t - rewards_std[j])) )
