        ...
        for i in pbar:
            ...
            for k in range(num_epochs):
                ...
                for j in range(num_actors):
                    ...
                    critic_loss += torch.mean( (gamma*critic_values_best_t1 - (critic_values_action_t - rewards[j]))**2 )
                    #critic_loss += torch.mean( (gamma*critic_values_action_t1 - (critic_values_action_t - rewards[j]))**2 )
                    ...
                    advantage = gamma*critic_values_action_t1 - (critic_values_action_t - rewards[j])
