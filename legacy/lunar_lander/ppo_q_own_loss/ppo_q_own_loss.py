        ...
        for i in pbar:
            ...
            for k in range(num_epochs):
                ...
                for j in range(num_actors):
                    ...
                    constant = 1.25
                    mse = constant *          (gamma*critic_values_best_t1 - (critic_values_action_t - rewards_std[j]))**2
                    mae = constant * torch.abs(gamma*critic_values_best_t1 - (critic_values_action_t - rewards_std[j]))
